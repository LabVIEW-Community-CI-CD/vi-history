...
// VI eligibility indexer - background indexing of VI files in workspace

import * as path from 'node:path';
import * as vscode from 'vscode';

import { GitApi, GitRepository } from '../git/gitApi.js';
import {
  getRepoHead,
  getRepoRoot,
  listTrackedFiles,
...
import { evaluateViEligibilityForFsPath } from '../services/viHistoryModel.js';
