...
// VI history model - view model for VI history panel

import * as path from 'node:path';

import { detectViSignatureFromFsPath } from '../domain/viFile.js';
import { ViSignature } from '../domain/viMagicCore.js';
import {
  getFileCommitHashes,
  getFileHistoryCount,
...
import { classifyRepositorySupportPolicy, RepositorySupportPolicy } from '../support/repositorySupportPolicy.js';
